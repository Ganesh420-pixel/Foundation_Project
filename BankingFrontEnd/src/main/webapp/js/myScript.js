...
async function checkLogin(loginObj) {
	...
	window.location.href = UI_URL + '/BankingFrontEnd/dashBoard.html';
...
async function addCustomer(customerObj) {
	...
	if (customer) {
		...
		window.location.href = UI_URL + '/BankingFrontEnd/login.html';
	}
...
if(message)
{
	...
	window.location.href = UI_URL + '/BankingFrontEnd/depositeMoney.html';
	console.log(message);
	}
	else
	{
...
if(message)
{
    ...
    const Bal = Number(accountBal) - Number(transactionObj.amount);
    localStorage.setItem("ACC_BAL", Bal);
	window.location.href = UI_URL + '/BankingFrontEnd/withdrawMoney.html';
	console.log(message);
	}
	else
	{
   ...
   if(message)
{
	...
	window.location.href = UI_URL + '/BankingFrontEnd/fundTransfer.html';
	console.log(message);
	}
	else
	{
